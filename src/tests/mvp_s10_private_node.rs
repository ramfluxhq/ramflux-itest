...
#[cfg(feature = "realnet")]
#[test]
fn mvp_s10_realnet_private_node_deploy_rf_dm() -> Result<(), Box<dyn std::error::Error>> {
    ...
    runtime.block_on(async {
        ...
        Box::pin(mvp_s10_assert_private_node_rf_dm(node.gateway_quic_addr, &node.ca_cert)).await?;
