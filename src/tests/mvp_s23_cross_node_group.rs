...
#[cfg(feature = "realnet")]
#[test]
fn mvp_s23_realnet_cross_node_group() -> Result<(), Box<dyn std::error::Error>> {
    ...
    runtime.block_on(async {
        Box::pin(mvp_s23_assert_cross_node_group(&node_a, &node_b)).await?;
